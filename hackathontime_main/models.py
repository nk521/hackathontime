...
class Hackathon(models.Model):
    ...
    hackathon_won = models.ForeignKey(Team, on_delete=models.SET_NULL, null=True, blank=True, related_name="+")
    hackathon_runnerup_1 = models.ForeignKey(Team, on_delete=models.SET_NULL, null=True, blank=True, related_name="++")
    hackathon_runnerup_2 = models.ForeignKey(Team, on_delete=models.SET_NULL, null=True, blank=True, related_name="++")
    ...
    def save(self, *args, **kwargs):
        if not self.hackathon_slug:
            self.hackathon_slug = slugify(self.hackathon_name + "-" + str(random.randint(1000,9999)))
